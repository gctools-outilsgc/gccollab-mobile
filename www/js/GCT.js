...
GCTLang = {
    txtNewsfeed: function (object) {
        var content = "<div class='swiper-slide list-block cards-list'>"
            ...
            + "<div  class='link like " + object.liked + "'><a href='#' aria-label='like aimer' data-guid='" + object.guid + "' data-type='" + object.type + "' onclick='GCTUser.LikePost(this);'><i class='fa fa-thumbs-o-up'></i></a> <a href='#' data-guid=" + object.guid + " onclick='GCTUser.GetLikeUsers(this);'><span class='like-count'>" + object.likes + "</span></a></div>"            
            + object.reply
            + object.action
            + "</div>"
            + "</div>"
...
GCTEach = {
    ...
    Newsfeed: function (value) {
        ...
        var reply = "";
        if (value.object.type == "wire") {
            action = "<a href='#' class='link' data-guid='" + value.object_guid + "' data-type='gccollab_wire_post' onclick='GCTUser.ViewPost(this);'>" + GCTLang.Trans("view") + "</a>";
            ...
            action = "<a href='#' class='link' data-guid='" + value.object_guid + "' data-type='gccollab_blog_post' onclick='GCTUser.ViewPost(this);'>" + GCTLang.Trans("view") + "</a>";
        }
